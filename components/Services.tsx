...
const services = [
  { id: 1, title: 'Anti-Aging', image: '/assets/botulinumtoxin/botox-faltenbehandlung_hero.webp', path: '/anti-aging' },
  { id: 2, title: 'Unterspritzungen & Fillers', image: '/assets//faltenunterspritzung/faltenunterspritzung_hero.webp', path: '/faltenunterspritzung' },
