  ...
  skin: [
    ...
    { label: 'Polynukleotide', href: '/polynukleotide' },
    {
      ...
      children: [
        ...
        { label: 'Microneedling + PRP', href: '/eigenbluttherapie/microneedling' },
      ...
      <div className="w-full mb-[96px]">
        <header
            className={`fixed top-0 w-full z-50 transition-all duration-300 ease-in-out border-b border-transparent ${
                scrolled ? 'py-2 bg-white/95 shadow-md backdrop-blur-md border-gray-100' : 'py-4 bg-white'
            }`}
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="hidden lg:flex lg:items-center lg:space-x-8 h-full">
                ...
                >
                  <button
                      className={`font-medium inline-flex items-center gap-1 transition-colors duration-200 py-6 ${
                          activeDesktopMenu === 'treatments' ? 'text-[#ac9769]' : 'text-gray-600 hover:text-black'
                      }`}
                  ...
                  <div
                      className={`absolute top-full left-1/2 -translate-x-1/2 w-[90vw] max-w-6xl bg-white shadow-xl border-t border-gray-100 rounded-b-xl overflow-hidden transition-all duration-300 transform origin-top ${
                          activeDesktopMenu === 'treatments'
        ...
        {/* --- MOBILE MENU OVERLAY --- */}
        <div
            className={`lg:hidden fixed inset-0 bg-white z-40 overflow-y-auto transition-transform duration-300 ease-in-out ${
