...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [
      'https://elaesthetics-bremen.de/elaesthetics-bremen-github/assets//skinbooster/og-skinbooster-bremen.webp',
    ],
  },
  alternates: {
...
export default function SkinboosterBremenPage() {
  const heroData: HeroSectionProps = {
    ...
    imageSrc: '/elaesthetics-bremen-github/assets//hyaluron/hyaluron-skinbooster_hero.webp',
    imageAlt:
  ...
  const quickInfoData: QuickInfoSectionProps = {
    ...
    benefits: [
      { title: 'Preis', description: 'ab 180€*', iconUrl: '/elaesthetics-bremen-github/assets//icons/EUR.svg' },
      { title: 'Dauer', description: '45–60 Min', iconUrl: '/elaesthetics-bremen-github/assets//icons/TIME.svg' },
      { title: 'Wirkeintritt', description: '3–4 Wochen', iconUrl: '/elaesthetics-bremen-github/assets//icons/CAL.svg' },
      { title: 'Sitzungen', description: '1–4 in der Aufbauphase (produktabhängig)', iconUrl: '/elaesthetics-bremen-github/assets//icons/wiederholung.svg' },
      { title: 'Anästhesie', description: 'auf Wunsch (Betäubungscreme)', iconUrl: '/elaesthetics-bremen-github/assets//icons/Spritze.svg' },
      { title: 'Gesellschaftsfähig', description: 'meist sofort', iconUrl: '/elaesthetics-bremen-github/assets//icons/gesellschaft.svg' },
    ],
