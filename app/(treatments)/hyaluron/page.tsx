...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ['https://elaesthetics-bremen.de/elaesthetics-bremen-github/assets//hyaluron/og-image-hyaluron-bremen.webp'],
  },
...
export default function HyaluronBremenPage() {
  ...
  const quickInfoData: QuickInfoSectionProps = {
    ...
    benefits: [
      { title: "Preis", description: `ab ${PRICES.hyaluronFiller.fillerUnterspritzung}€*`, iconUrl: "/elaesthetics-bremen-github/assets//icons/EUR.svg" },
      ...
      { title: "Haltbarkeit", description: "6-18 Monate", iconUrl: "/elaesthetics-bremen-github/assets//icons/CAL.svg" },
      { title: "Betäubung", description: "Creme möglich, oft nicht nötig", iconUrl: "/elaesthetics-bremen-github/assets//icons/Spritze.svg" },
