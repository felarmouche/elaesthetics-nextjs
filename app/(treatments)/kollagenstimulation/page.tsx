...
export default function KollagenstimulationPage() {
  ...
  const treatmentsData: TreatmentsSectionProps = {
    ...
    treatments: [
      {
        imageUrl: '/assets/hyaluron/hyaluron-filler.webp',
      ...
      {
        imageUrl: '/assets/prf/prf-hero.webp',
        imageAlt: 'PRF/PRP Eigenblut',
        title: 'PRF/PRP',
        description: 'Autologe Regeneration zur Unterstützung der Hautqualität.',
        treatmentUrl: '/prf',
      },
      {
        imageUrl: '/assets/microneedling/mn-hero.webp',
        ...
        treatmentUrl: '/microneedling',
      },
      {
        imageUrl: '/assets/meso/meso-hero.webp',
      ...
      {
        imageUrl: '/assets/polynukleotide/pn-hero.webp',
