...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'de_DE',
    images: ['https://elaesthetics-bremen.de/assets/eigenbluttherapie-prf/og-eigenbluttherapie-prf.png'],
  },
  alternates: {
...
export default function EigenbluttherapiePRFPage() {
  const heroData: HeroSectionProps = {
    ...
    imageSrc: '/assets/eigenbluttherapie-prf/eigenbluttherapie-prf_hero.png',
    imageAlt:
