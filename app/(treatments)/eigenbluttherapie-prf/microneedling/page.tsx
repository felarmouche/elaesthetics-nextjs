...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'de_DE',
    images: ['https://elaesthetics-bremen.de/elaesthetics-bremen-github/assets//prf/prf-microneedling-og.webp'],
  },
  alternates: {
...
export default function PRFMicroneedlingPage() {
  const heroData: HeroSectionProps = {
    ...
    imageSrc: "/elaesthetics-bremen-github/assets//eigenbluttherapie-prf/eigenbluttherapie-prf-microneedling_hero.webp",
  ...
  const quickInfoData: QuickInfoSectionProps = {
    ...
    benefits: [
      { title: "Preis", description: `ab ${PRICES.prpPrf.microneedling}€*`, iconUrl: "/elaesthetics-bremen-github/assets//icons/EUR.svg" },
      { title: "Dauer", description: "ca. 60–90 Min", iconUrl: "/elaesthetics-bremen-github/assets//icons/TIME.svg" },
      { title: "Wirkeintritt", description: "nach 3–5 Behandlungen", iconUrl: "/elaesthetics-bremen-github/assets//icons/CAL.svg" },
      { title: "Intervall", description: "Serienabstand ~4 Wochen", iconUrl: "/elaesthetics-bremen-github/assets//icons/wiederholung.svg" },
      { title: "Betäubung", description: "lokal auf Wunsch", iconUrl: "/elaesthetics-bremen-github/assets//icons/Spritze.svg" },
      { title: "Downtime", description: "ca. 1–3 Tage", iconUrl: "/elaesthetics-bremen-github/assets//icons/gesellschaft.svg" }
    ],
  ...
  const treatmentsData: TreatmentsSectionProps = {
    ...
    treatments: [
      ...
      {
        imageUrl: "/elaesthetics-bremen-github/assets//eigenbluttherapie-prf/eigenbluttherapie-prf-vampire-lifting_hero.webp",
