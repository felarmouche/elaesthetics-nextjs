...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [
      'https://elaesthetics-bremen.de/elaesthetics-bremen-github/assets//prf/og-prf-haare-haarausfall-bremen.webp',
    ],
  },
  alternates: {
...
export default function PRFHaarePage() {
  const heroData: HeroSectionProps = {
    ...
    imageSrc: '/elaesthetics-bremen-github/assets//eigenbluttherapie-prf/eigenbluttherapie-prf-haare_hero.webp',
    imageAlt:
  ...
  const treatmentsData: TreatmentsSectionProps = {
    ...
    treatments: [
      {
        imageUrl: '/elaesthetics-bremen-github/assets//mesotherapie/mesotherapie-haare_hero.webp',
