...
export const metadata: Metadata = {
  ...
  description:
    'Volumenaufbau & Filler. Konturierung von Lippen, Wangen, Kinn & Jawline. Natürliche Ergebnisse ohne „künstlichen“ Look.',
  openGraph: {
    title:
      'Filler in Bremen – Volumenaufbau & Konturierung | EL Aesthetics',
    description:
      'Entdecken Sie die Möglichkeiten der Filler-Behandlungen in Bremen für eine natürliche Konturierung von Lippen, Wangen, Kinn & Jawline. Hyaluronsäure Filler, PRF und Biostimulatoren für voluminöse Ergebnisse.',
    type: 'website',
    locale: 'de_DE',
...
export default function fillerHubPage() {
    ...
    treatments: [
      {
        ...
        title: 'Kollagenstimulation (CaHA & PLLA)',
        description:
      ...
      },
      {
        ...
        imageAlt: 'Bild zu Hyaluronsäure Filler Behandlung',    
        title: 'Hyaluronsäure Filler',
        description:
          'Hyaluronsäure Filler sind vielseitig einsetzbar für Volumenaufbau, Konturierung und Faltenbehandlung. Sie eignen sich für die Modellierung von Wangen, Kinn, Jawline, Lippen & mehr.',
  ...
  const ctaData: CTASectionProps = {
    title: 'Welche Möglichkeiten bieten Filler in Bremen?',
    subtitle:
      'Termin zur Filler-Behandlung in Bremen vereinbaren: Hautbild & Hautstruktur verbessern mit Skinboostern (inkl. Profhilo/BAP-Technik), PRF/Polynukleotiden, (RF-)Microneedling, Peelings, Mesobotox/Microbotox & Kollagenstimulation – unterstützend bei Pigmentflecken, Rosazea/Couperose, großen Poren & Aknenarben.',
