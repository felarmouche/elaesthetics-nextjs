...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'de_DE',
    images: ['https://elaesthetics-bremen.de/assets/filler/og-image-faltenunterspritzung-bremen.png'],
  },
  alternates: {
...
export default function FaltenunterspritzungHubPage() {
  const heroData: HeroSectionProps = {
    ...
    imageSrc: '/assets/faltenunterspritzung/faltenunterspritzung_hero.png',
    imageAlt:
